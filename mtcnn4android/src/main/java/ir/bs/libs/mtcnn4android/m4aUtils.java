...
public class m4aUtils {
    ...
    public static void drawRect(Bitmap bitmap, Rect rect) {
        int r = 244;//(int)(Math.random()*255);
        int g = 67;//(int)(Math.random()*255);
        int b = 54;//(int)(Math.random()*255);
        drawRect(bitmap, rect, Color.rgb(r, g, b));
    }
    ...
    public static void drawRect(Bitmap bitmap, Rect rect, int color) {
        try {
            ...
            paint.setStrokeWidth(2 + bitmap.getWidth() / 500);
